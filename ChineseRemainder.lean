...
theorem AsianLeftoversfor2 {x0 a1 a2 k: ℤ} {m1 m2 : ℕ } (g1:m1.gcd m2 = 1)
(g2:m1>0) (g3:m2>0) (g4: m=m1*m2):∃x0, (x0=a1.bmod m1 ∧ x0=a2.bmod m2)
∧ ∀k, ((k*m+x0)=a1.bmod m1 ∧ (k*m+x0)=a2.bmod m2)  := by
